...
class TestGetDataAlphaNumeric(BaseVDERPCommandTestCase):
    ...
    def setUp(self):
        ...
        self.lut_data['command']='GetAlphaNumeric'
    ...
    def testGetData(self):
        ...
        self.assertTrue(gdObj.priority_prompt, "Priority prompt should be false for GetAlphaNumeric command")
    ...
    def testGetDataAlphaNumericMinGreaterMaxDialog(self):
        ...
        try:
            ...
            if(len(mock_catalyst.log_messages) == 0):        
                ...
                objString = 'Min Length greater than max length for command GetAlphaNumeric'
    ...
    def testGetDataAlphaNumericGreaterThanMaxDialog(self):
        ...
        self.post_dialog_responses('123ABCD!')
