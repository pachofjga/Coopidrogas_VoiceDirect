...
class TestGetDataNumeric(BaseVDERPCommandTestCase):
    ...
    def testGetData(self):
        ...
        self.assertTrue(gdObj.priority_prompt, "Priority prompt should be false for GetNumeric command")
    ...
    def testGetDataNumericValidateDialog(self):
        ...
        self.validate_prompts('This is a prompt', 'Validate pre prompt <Spell>2</Spell>, validate post prompt')
